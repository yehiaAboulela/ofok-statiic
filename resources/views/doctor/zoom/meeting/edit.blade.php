            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('doctor.update-zoom-meeting',$meeting->meeting_id) }}" method="POST">
                        ...
                        <button class="btn btn-primary" type="submit"> {{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','update')->first()->custom_lang :$websiteLang->where('lang_key','update')->first()->default_lang }}</button>
                    </form>
                </div>
            </div>
