...
<style>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('doctor.old.appointment',$appointment->user_id) }}">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','history_here')->first()->custom_lang : $websiteLang->where('lang_key','history_here')->first()->default_lang }}</a></td>
                        </tr>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','physical_info')->first()->custom_lang : $websiteLang->where('lang_key','physical_info')->first()->default_lang }} </label>
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','advice')->first()->custom_lang : $websiteLang->where('lang_key','advice')->first()->default_lang }}</h6>
                </div>
        ...
        <button type="submit" class="btn btn-success ml-3">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','save')->first()->custom_lang : $websiteLang->where('lang_key','save')->first()->default_lang }}</button>
        </form>
