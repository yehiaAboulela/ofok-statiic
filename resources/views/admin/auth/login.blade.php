                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ $websiteLang->where('lang_key','admin_login')->first()->custom_lang }}</h1>
                                </div>
                                <form class="user" action="{{ route('admin.login') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-user btn-block">
                                        {{ $websiteLang->where('lang_key','login')->first()->custom_lang }}
                                    </button>
                                    <hr>
                                </form>
                                <div class="text-center">
                                    <a class="small" href="{{ route('admin.forget.password') }}">{{ $websiteLang->where('lang_key','forget_your_pass')->first()->custom_lang }}</a>
                                </div>
                            </div>
                        </div>
