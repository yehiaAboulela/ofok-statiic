                        ...
                        <div class="row">
                            @foreach(config('app.available_locales') as $locale)
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$laboratory->getTranslation('name',$locale)}}" class="form-control" name="name[{{$locale}}]"
                                               required>
                                    </div>
                                    @error('name.'.$locale)
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('phone',$laboratory->phone)}}" class="form-control" name="phone" id="phone">
                                </div>
                                @error('phone')
                                <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('address',$laboratory->address)}}"  class="form-control" name="address" id="address" required>
                                </div>
                                @error('address')
                                <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('working_time',$laboratory->working_time)}}" class="form-control" name="working_time" id="working_time">
                                </div>
                                @error('working_time')
                                <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" value="{{old('working_time',$laboratory->map_url)}}" class="form-control" name="map_url" id="map_url">
                                </div>
                                @error('map_url')
                                <div class="text-danger"> {{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-check">
                                    <input class="form-check-input" name="is_active" type="checkbox" value="1"
                                           id="flexCheckChecked" {{$laboratory->is_active ? 'checked':''}}>
