                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endphp
                                <td>{{ $doctor_email }}</td>
                                <td>{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','doctor_email')->first()->custom_lang : $websiteLang->where('lang_key','doctor_email')->first()->default_lang }}</td>
                            </tr>
                            <tr>
                                @php
                                    $password="{{password}}";
                                @endphp
                                <td>{{ $password }}</td>
                                <td>{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','doc_pass')->first()->custom_lang : $websiteLang->where('lang_key','doc_pass')->first()->default_lang }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
