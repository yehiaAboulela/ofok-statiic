...
@section('title')
<title>{{ $websiteLang->where('lang_key','upcoming_meeting')->first()->custom_lang }}</title>
@endsection
@section('doctor-content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','upcoming_meeting')->first()->custom_lang }}</h6>
        </div>
        <div class="card-body">
