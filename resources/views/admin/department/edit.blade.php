        ...
        <div class="col-md-10">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','dep_form')->first()->custom_lang : $websiteLang->where('lang_key','dep_form')->first()->default_lang }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.department.update',$department->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="{{ $department->getTranslation('name', 'en') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_ar" id="name_ar" value="{{ $department->getTranslation('name', 'ar') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="summernote" id="description" name="description">{{ $department->getTranslation('description', 'en') }}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="description_ar">{{ __('dashboard.department.Description In Arabic') }}</label>
                            <textarea class="summernote" id="description_ar" name="description_ar">{{ $department->getTranslation('description', 'ar') }}</textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option {{ $department->status ==1 ? 'selected' :'' }} value="1">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','active')->first()->custom_lang : $websiteLang->where('lang_key','active')->first()->default_lang }}</option>
                                        <option {{ $department->status ==0 ? 'selected' :'' }} value="0">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','inactive')->first()->custom_lang : $websiteLang->where('lang_key','inactive')->first()->default_lang }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="show_homepage" id="show_home_page" class="form-control">
                                        <option {{ $department->show_homepage ==0 ? 'selected' :'' }} value="0">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','no')->first()->custom_lang : $websiteLang->where('lang_key','no')->first()->default_lang }}</option>
                                        <option {{ $department->show_homepage ==1 ? 'selected' :'' }} value="1">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','yes')->first()->custom_lang : $websiteLang->where('lang_key','yes')->first()->default_lang }}</option>
                                    </select>
                                </div>
                            </div>
