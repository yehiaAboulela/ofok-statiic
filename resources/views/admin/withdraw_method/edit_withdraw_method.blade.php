...
@section('title')
<title>{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','edit_method')->first()->custom_lang : $websiteLang->where('lang_key','edit_method')->first()->default_lang }}</title>
@endsection
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','edit_withdraw_method')->first()->custom_lang : $websiteLang->where('lang_key','edit_withdraw_method')->first()->default_lang }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.withdraw-method.update', $method->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" value="{{ $method->name }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="minimum_amount" class="form-control" id="minimum_amount" value="{{ $method->min_amount }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="maximum_amount" class="form-control" id="maximum_amount" value="{{ $method->max_amount }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="withdraw_charge" class="form-control" id="withdraw_charge" value="{{ $method->withdraw_charge }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="summernote" cols="30" rows="3" class="form-control" >{{ $method->description }}</textarea>
