...
@section('title')
<title>{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','faq')->first()->custom_lang : $websiteLang->where('lang_key','faq')->first()->default_lang }}</title>
@endsection
@section('admin-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800 d-inline"><a href="{{ route('admin.faq-category.index') }}" class="btn btn-primary"><i class="fas fa-list" aria-hidden="true"></i> {{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','faq_cat')->first()->custom_lang : $websiteLang->where('lang_key','faq_cat')->first()->default_lang }} </a></h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','faq_table')->first()->custom_lang : $websiteLang->where('lang_key','faq_table')->first()->default_lang }}</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','cat')->first()->custom_lang : $websiteLang->where('lang_key','cat')->first()->default_lang }}</th>
