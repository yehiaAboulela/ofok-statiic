        ...
        <div class="row">
            <div class="col-md-12">
                <div class="banner-text">
                    <h1>{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','upcoming_meeting')->first()->custom_lang : $websiteLang->where('lang_key','upcoming_meeting')->first()->default_lang }}</h1>
                    <ul>
                        <li><a href="{{ url('/') }}">{{ $navigation->home }}</a></li>
                        <li><span>{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','upcoming_meeting')->first()->custom_lang : $websiteLang->where('lang_key','upcoming_meeting')->first()->default_lang }}</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="detail-dashboard">
                    <h2 class="d-headline">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','upcoming_meeting')->first()->custom_lang : $websiteLang->where('lang_key','upcoming_meeting')->first()->default_lang }}</h2>
