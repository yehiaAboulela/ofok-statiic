				...
				<div class="regiser-form login-form">
					<form action="{{ route('register') }}" method="POST">
						...
						<div class="form-row row">
                            ...
                            @endif
							<div class="form-group col-12">
								<button type="submit" class="btn btn-primary">{{ app()->currentLocale() == 'ar' ? $websiteLang->where('lang_key','register')->first()->custom_lang : $websiteLang->where('lang_key','register')->first()->default_lang }}</button>
							</div>
						</div>
					</form>
